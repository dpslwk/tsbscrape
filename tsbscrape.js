...
function matchTransferAccount(description) {
  patterns = {
    ...
    '3D INDUCT': 'Income:Inductions:3D Printer Induction',
    'EM INDUCT': 'Income:Inductions:Embroidery Induction',
    'LASER INDUCT': 'Income:Inductions:Laser Induction',
    'LATHE INDUCT': 'Income:Inductions:Lathe Induction',
    'MILL INDUCT': 'Income:Inductions:Mill Induction',
    'PLANER INDUCT': 'Income:Inductions:Planer Thicknesser Induction',
    'TABLESAW INDU': 'Income:Inductions:Table Saw Induction',
    'TIG INDUCT': 'Income:Inductions:Tig Induction',
